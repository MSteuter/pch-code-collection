/**
 * This class implements the logger of clean home and forward it to iobroker
 *
 * @author Christopher Holomek
 * @since 25.04.2020
 */
import {Logger} from 'clean-home';
import {Pch} from './main';

export class PchLogger implements Logger {

    constructor(private adapter: Pch) {
    }
